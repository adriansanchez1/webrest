...
public class ShipToController {
	...
	@RequestMapping(value = "/ResultSearch", method = RequestMethod.GET, params = {"ShippingZone"})
	public String ShipToSearchResult(@RequestParam("ShippingZone")String ShippingZone,Model model) {
		model.addAttribute("shipTos",shipToService.getShipToByShippingZone(ShippingZone));
		return "shipTo/list";
	}
}
