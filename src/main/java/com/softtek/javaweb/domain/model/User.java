...
@NamedQuery(name="User.findByUserRoleId",query="SELECT u FROM User u WHERE u.userRole.userRoleId=:userRoleId")
@NamedNativeQuery(name="User.findByUserRoleIdNative",query="SELECT * FROM User u WHERE user_role_id=:userRoleId")
